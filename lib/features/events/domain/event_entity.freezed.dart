...
mixin _$EventEntity {
  ...
  String get category =>
      throw _privateConstructorUsedError; // Exam, Project, Reminder
...
// Exam, Project, Reminder
  @override
  final int color;

  @override
  String toString() {
    return 'EventEntity(id: $id, title: $title, description: $description, date: $date, category: $category, color: $color)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, date, category, color);
...
abstract class _EventEntity implements EventEntity {
  const factory _EventEntity(
      ...
      required final int color}) = _$EventEntityImpl;
  ...
  DateTime get date;
  @override
  String get category; // Exam, Project, Reminder
  @override
  int get color;
