...
mixin _$NoteEntity {
  ...
  String get content =>
      throw _privateConstructorUsedError; // JSON string for Quill or plain text
...
// JSON string for Quill or plain text
  @override
...
abstract class _NoteEntity implements NoteEntity {
  const factory _NoteEntity(
      ...
      required final DateTime updatedAt}) = _$NoteEntityImpl;
  ...
  String get title;
  @override
  String get content; // JSON string for Quill or plain text
  @override
